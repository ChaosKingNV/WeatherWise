...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget2->setGeometry(QRect(370, 100, 130, 18));
        ...
        layoutWidget6->setGeometry(QRect(11, 150, 121, 16));
        ...
        txtDetails = new QTextEdit(layoutWidget);
        txtDetails->setObjectName("txtDetails");
        txtDetails->setMinimumSize(QSize(0, 200));

        verticalLayout_3->addWidget(txtDetails);
